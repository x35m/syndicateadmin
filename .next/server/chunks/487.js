"use strict";exports.id=487,exports.ids=[487],exports.modules={9487:(e,t,a)=>{a.d(t,{db:()=>E});let i=new(a(5900)).Pool({connectionString:process.env.DATABASE_URL||process.env.DATABASE_PUBLIC_URL,ssl:{rejectUnauthorized:!1}});class r{materialSelect(e){return`SELECT m.id,
    ...
    `)).rows[0]}async close(){await i.end()}async addFeed(e,t,a){return(await i.query(`INSERT INTO feeds (url, title, description)
       ...
       DO UPDATE SET value = $2, updated_at = NOW()`,[e,t])}async getSettings(){let e=await i.query("SELECT key, value FROM settings"),t={};return e.rows.forEach(e=>{t[e.key]=e.value}),t}async updateMaterialSummary(e,t){let a=[],r=[],E=1;void 0!==t.summary&&(a.push(`summary = $${E}`),r.push(t.summary),E++),void 0!==t.metaDescription&&(a.push(`meta_description = $${E}`),r.push(t.metaDescription),E++),void 0!==t.sentiment&&(a.push(`sentiment = $${E}`),r.push(t.sentiment),E++),void 0!==t.contentType&&(a.push(`content_type = $${E}`),r.push(t.contentType),E++),!0===t.setProcessed&&(a.push("processed = TRUE"),a.push(`status = CASE
        ...
        ELSE 'processed'
      END`)),a.length>0&&(r.push(e),await i.query(`UPDATE materials SET ${a.join(", ")} WHERE id = $${E}`,r))}async getCategoryExamples(e=15){return(await i.query(`
      SELECT 
        m.id,
        m.title,
        m.summary,
