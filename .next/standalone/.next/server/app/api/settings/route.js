"use strict";(()=>{var t={};t.id=668,t.ids=[668],t.modules={399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:t=>{t.exports=require("pg")},5171:(t,e,a)=>{a.r(e),a.d(e,{originalPathname:()=>_,patchFetch:()=>S,requestAsyncStorage:()=>l,routeModule:()=>g,serverHooks:()=>y,staticGenerationAsyncStorage:()=>c});var i={};a.r(i),a.d(i,{GET:()=>d,POST:()=>m});var s=a(9303),n=a(8716),o=a(670),r=a(7070),p=a(9487),u=a(7435);async function d(){try{let t=await p.db.getSetting("gemini_api_key"),e=await p.db.getSetting("claude_api_key"),a=await p.db.getSetting("ai_provider")||"gemini",i=await p.db.getSetting("gemini_model")||"gemini-2.5-flash",s=await p.db.getSetting("claude_model")||"claude-sonnet-4-20250514",n=await p.db.getSetting("analysis_prompt"),o=await p.db.getSetting("summary_prompt"),u=await p.db.getSetting("taxonomy_system_prompt"),d=await p.db.getSetting("taxonomy_format_prompt"),m=`Ты - аналитик новостного контента. Проанализируй статьи, создай качественные саммари и оцени характеристики материала.
